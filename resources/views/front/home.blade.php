                ...
                <div class="col-xxl-7 col-xl-6">
                    <div class="thumb-part">
                        <div class="banner-thumb text-center">
                            <img src="{{ asset('assets/images/banner/02.png') }}" alt="img">
                        </div>
    ...
    <div class="container">
        <div class="row d-flex g-1">
            <div class="col-md-4 col-sm-12 col-lg-4 text-center bg-white p-2">
                <img src="{{ asset('assets/images/custom/login.jpg') }}" width="" height=""
                    alt="about icon">
            </div>
            <div class="col-md-4 col-sm-12 col-lg-4 text-center bg-white p-2 ">
                <img src="{{ asset('assets/images/custom/poster.jpg') }}" class="rounded" width=""
                    height="auto" alt="about icon">
            </div>
            <div class="col-md-4 col-sm-12 col-lg-4 text-center bg-white p-2">
                <img src="{{ asset('assets/images/custom/quiz.jpg') }}" width="" height=""
                    alt="about icon">
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-lg-12 bg-dark p-4">
            ...
            <form action="">
                <div class="row">
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        ...
                        <select class="single" class="js-states form-control">
                            <option  value="">........</option>
                            <option>Java</option>
                    ...
                    <div class="col-md-3 col-sm-12  col-xs-12">
                        <label>Niveaux</label>
                        <select class="multiple" class="js-states form-control" multiple>
                            <option>Java</option>
                            <option>Javascript</option>
                            <option>PHP</option>
                            <option>Visual Basic</option>
