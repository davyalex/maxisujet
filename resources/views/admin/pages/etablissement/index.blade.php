                                ...
                                <tbody>
                                    ...
                                    @foreach ($etablissements as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" data-toggle="modal" data-target="#modalEdit"><i class="fas fa-edit fs-20"
                                         ...
                                         {{-- modal edit form --}}
                            @include('admin.pages.etablissement.edit')
                                    @endforeach
                                </tbody>
                            </table>

                            {{-- modal create form --}}
                            @include('admin.pages.etablissement.create')
                        </div>
                    </div>
                </div>
            </div>
            ...
            $('.delete').on("click", function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "/admin/etablissement/destroy/" + Id,
                            dataType: "json",
                            data: {
                                _token: '{{ csrf_token() }}',
